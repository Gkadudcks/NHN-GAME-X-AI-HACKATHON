...
이 저장소에는 목적이 다른 두 에셋 루트가 있습니다.

- `assets/art/`: 생성 이미지의 원본, 승인 상태, 프롬프트, 생성 로그, 안정 ID 매니페스트를 관리하는 소스 오브 트루스입니다.
- `NAN_GAME_TITLE/assets/`: 브라우저 게임이 직접 사용하는 폰트, 오디오, 초기 레거시 이미지 같은 런타임 정적 파일입니다.
