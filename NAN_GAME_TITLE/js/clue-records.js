(function exposeClueRecords(root, factory) {
  ...
  const RECORDS = Object.freeze([
    ...
    },
    {
      ...
      detail: "자료실의 ‘2024_신규유저개선_이전자료’ 폴더 담당자는 서하린으로 표시되어 있었다. 하린은 이번 조사와 무관하다며 폴더를 빠르게 닫으려 했다.",
    ...
    },
    {
      ...
      theme: "검증 기록",
      title: "DAY 2 검증 기준",
      detail: "최근 7일 신규 설치 12,480명, 첫 전투 도달 8,502명, 첫 전투 이전 이탈률 31.9%, 가장 최근 자료의 신규 유저 7일 차 잔존율 18.4%를 원본 통계 링크와 함께 확인했다.",
    ...
    },
    {
      ...
      day: 2,
      theme: "변조와 실행 기록",
      title: "꺼지지 않고 남아있던 자동 연결",
      detail: "2024_신규유저개선_이전자료 폴더에는 꺼진 것처럼 보였지만 실제로는 삭제되지 않은 자동 연결 기능이 남아 있었다. 화면에는 등록 담당자: 서하린, 마지막 실행: 2024-11-07 23:48로 표시되었다.",
    ...
    },
    {
      ...
      day: 3,
      theme: "변조와 실행 기록",
      title: "문서가 바뀐 순간과 겹치는 자동 실행",
      detail: "작업본이 바뀐 바로 그 시각에 자동 연결 기능이 실행됐다. 다만 요청한 계정은 권한 부족으로 화면에 표시되지 않는다.",
    },
    {
    ...
    },
    {
      ...
      theme: "검증 기록",
      title: "7일 차 잔존율 18.4%",
      detail: "가장 최근 자료의 신규 가입자를 대상으로 원본 데이터와 계산식을 대조한 결과 7일 차 잔존율은 18.4%로 확인되었다.",
    },
    {
      ...
      detail: "DAY 4 17:08에 발표 자료와 제출용 근거 자료 모두 18.4%로 표시되었고 원본 링크가 정상임을 확인했다.",
    },
    {
      id: "d5_security_audit_result",
      day: 5,
      theme: "보안 감사",
      title: "재실행을 요청한 진짜 계정: 강민재",
      detail: "09:58 자료 연결 변경 직전에 강민재 계정의 재실행 요청이 접수되었다. 실행 서비스는 나나봇이며, 서하린의 직접 접근과 수치 직접 입력 기록은 확인되지 않았다.",
    },
  ]);
