(function initDay5Story(global) {
  ...
  const officeExterior = "background.office_exterior.night";
  ...
  const scenes = Object.freeze([
    ...
    { id: "day5RecoveryBasis", time: "10:47", speaker: "한도윤", text: "발표 자료와 같은 분석 대상과 기간을 확인하자.", visual: "PPT에 분석 대상과 기간 조합이 비교 표시된다.", bgAssetId: meeting, playerRecovery: true, system: { title: "03 · 분석 기준 확인", rows: ["발표 자료 대상 · 신규 가입 사용자", "발표 자료 기간 · 발표 전주", "측정 시점 · 가입 7일 후", "선택 · 같은 분석 기준"] }, choiceKey: "recoveryBasis", choices: [
    ...
    { id: "day5SupportRecoveryStart", time: "10:45", speaker: "시스템 담당자", text: "플레이어의 직접 검증을 종료합니다. 지금부터 보안 감사 원문을 기준으로 지원 복구를 진행하겠습니다.", visual: "생명이 모두 소진된 직후 조작이 종료되고 지원 복구 진행 화면으로 전환된다.", bgAssetId: meeting, supportRecovery: true, system: { title: "지원 복구 시작", rows: ["플레이어 조작 · 종료", "검증 등급 · 실패", "복구 담당 · 시스템 담당자", "기준 기록 · 보안 감사 원문"] } },
    { id: "day5SupportRecoveryShock", time: "10:45", speaker: "한도윤", text: "화면이 내 손을 떠나 스스로 움직이기 시작했다. 다섯 번의 기회를 다 쓰고 나서야, 지금까지 이게 얼마나 위태로운 상태였는지 실감이 났다.", visual: "도윤이 더 이상 반응하지 않는 키보드와 마우스를 내려다본다.", bgAssetId: meeting, supportRecovery: true },
    ...
    { id: "day5SupportRecoveryComplete", time: "10:48", speaker: "시스템", text: "담당자 지원으로 정상 원본 복구가 완료되었습니다. 플레이어 직접 해결 기록은 실패로 유지됩니다.", visual: "지원 복구 완료와 직접 검증 실패가 서로 다른 상태로 함께 표시된다.", bgAssetId: meeting, supportRecovery: true, system: { title: "지원 복구 완료", rows: ["정상 원본 · 18.4%", "자료 연결 · 고정 완료", "복구 방식 · 담당자 지원", "직접 검증 · 실패"] } },
    ...
    { id: "day5MinjaeAfterHoursReply", time: "16:11", speaker: "한도윤", text: "필요하면 나중에 다시 얘기하죠. 지금은 결과부터 기다립시다.", visual: "도윤이 짧게 답하고 다시 화면으로 시선을 돌린다.", bgAssetId: office, characters: minjae },
    ...
    { id: "day5BadEnd", ending: "bad", time: "20:20", speaker: "한도윤", text: "그래, 여기까진가 보다.\n\nBAD ENDING\n정직원 전환은 끝내 승인되지 않았다. 도윤은 짐 상자를 들고 어두워진 사무실을 나섰다.", location: "게임사업실 · 퇴사", visual: "도윤이 개인 물품을 담은 상자를 품에 안고 사무실 문을 나선다. 창밖은 이미 캄캄하다.", bgAssetId: "background.office.night", end: true, bgm: "badEnding" },
    ...
    { id: "day5MiddleExit", ending: "middle", time: "18:23", speaker: "시스템", text: "문이 열리고, 두 사람은 나란히 로비를 지나 건물 밖으로 걸어 나왔다.", location: "회사 건물 밖 · 퇴근", visual: "로비를 지나 자동문 밖으로 나서는 도윤과 하린. (배경 준비 전: background.office_exterior.night 승인 후 bgAssetId 연결 예정)" },
    { id: "day5MiddleOutside", ending: "middle", time: "18:24", speaker: "서하린", text: "오늘 흔들릴 때 옆에서 붙잡아 준 건 잊지 않을게요.", visual: "선선한 밤바람 속에서 하린이 오늘 하루를 돌아보며 말한다.", characters: harinSmile, activeCharacter: "harin" },
    { id: "day5MiddleEnd", ending: "middle", time: "18:25", speaker: "한도윤", text: "저도 오늘 선배 없었으면 못 버텼을 겁니다.\n\nMIDDLE ENDING\n사수와 신입으로 시작한 두 사람은 서로 믿고 일할 수 있는 동료가 되었다.", visual: "건물 밖 가로등 불빛 아래, 두 사람이 나란히 걸어간다.", characters: harinSmile, end: true, bgm: "middleEnding" },
