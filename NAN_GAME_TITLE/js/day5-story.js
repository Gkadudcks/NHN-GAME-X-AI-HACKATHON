(function initDay5Story(global) {
  ...
  const scenes = Object.freeze([
    ...
    { id: "day5MiddleEnd", ending: "middle", time: "18:25", speaker: "한도윤", text: "저도 오늘 선배 없었으면 못 버텼을 겁니다.\n\nMIDDLE ENDING\n사수와 신입으로 시작한 두 사람은 서로 믿고 일할 수 있는 동료가 되었다.", visual: "건물 밖 가로등 불빛 아래, 두 사람이 나란히 걸어간다.", characters: harinSmile, cgAssetId: "event_cg.day5.colleague_departure", cgTitle: "함께한 퇴근길", cinematicDelay: 1600, end: true, bgm: "middleEnding" },
