(function initDay5Story(global) {
  ...
  const scenes = Object.freeze([
    ...
    { id: "day5PresentationStart", time: "10:00", speaker: "한도윤", dynamic: "presentationOpening", text: "신규 유저 첫 전투 도달률 개선안을 말씀드리겠습니다.", location: "발표실 · 발표", visual: "도윤이 신규 유저 첫 전투 도달률 개선안 발표를 시작한다.", bgAssetId: meeting, system: { title: "신규 유저 첫 전투 도달률 개선안", rows: ["현재 문제 · 첫 전투 이전 이탈", "개선 원칙 · 첫 성공 경험 앞당기기", "적용 방식 · 일부 신규 유저 대상 검증"] }, bgm: "presentationCalm" },
    { id: "day5PresentationProblem", time: "10:01", speaker: "한도윤", text: "최근 신규 설치자는 1만 2,500여 명입니다. 이 중 8,500여 명이 첫 전투에 도달했습니다.", visual: "신규 설치부터 첫 전투 도달까지의 퍼널과 이탈 규모가 발표 화면에 표시된다.", bgAssetId: meeting, system: { title: "현재 문제", rows: ["신규 설치 · 12,480명", "첫 전투 도달 · 8,502명", "첫 전투 이전 이탈 · 3,978명", "첫 전투 이전 이탈률 · 31.9%"] } },
    { id: "day5PresentationProblemScale", time: "10:01", speaker: "한도윤", text: "약 4,000명, 전체의 31.9%가 첫 전투 전에 이탈하고 있습니다.", visual: "첫 전투 이전 이탈 인원과 비율이 강조된다.", bgAssetId: meeting, system: { title: "현재 문제", rows: ["신규 설치 · 12,480명", "첫 전투 도달 · 8,502명", "첫 전투 이전 이탈 · 3,978명", "첫 전투 이전 이탈률 · 31.9%"] } },
    { id: "day5PresentationSolution", time: "10:03", speaker: "한도윤", text: "최근 신규 유저의 7일 후 잔존율은 18.4%로, 개선이 필요합니다.", visual: "현재 7일 차 잔존율과 개선 필요성이 발표 화면에 표시된다.", bgAssetId: meeting, system: { title: "현재 잔존율", rows: ["7일 후 잔존율 · 18.4%", "대상 · 신규 유저", "자료 기준 · 가장 최근 자료", "평가 · 개선 필요"] } },
    { id: "day5PresentationFocusDetail", time: "10:04", speaker: "한도윤", dynamic: "presentationResearchEvidence", text: "사용자 조사에서 확인한 원인을 말씀드리겠습니다.", visual: "도윤이 DAY 2에서 조사한 원인 근거를 발표 화면에 연결한다.", bgAssetId: meeting },
    { id: "day5PresentationFocusConclusion", time: "10:05", speaker: "한도윤", dynamic: "presentationResearchConclusion", text: "조사 결과를 바탕으로 개선해야 할 핵심 원인을 정리한다.", visual: "조사 결과의 핵심 원인이 발표 화면에 강조된다.", bgAssetId: meeting },
    { id: "day5PresentationMetric", time: "10:06", speaker: "한도윤", text: "조사 방식은 달랐지만 공통 원인은 통제권과 다음 목표의 상실이었습니다.", visual: "서로 다른 조사 결과가 하나의 공통 결론으로 모인다.", bgAssetId: meeting, system: { title: "공통 결론", rows: ["공통 원인 · 통제권과 다음 목표 상실", "개선 방향 · 설명 추가가 아닌 순서 조정", "목표 · 첫 성공 경험 앞당기기"] }, camera: "focus" },
    { id: "day5PresentationMetricConclusion", time: "10:06", speaker: "한도윤", text: "설명을 늘리기보다 직접 행동하고 첫 성공을 경험하는 순서를 앞당기겠습니다.", visual: "첫 성공 경험을 앞당기는 개선 방향이 강조된다.", bgAssetId: meeting, system: { title: "공통 결론", rows: ["공통 원인 · 통제권과 다음 목표 상실", "개선 방향 · 설명 추가가 아닌 순서 조정", "목표 · 첫 성공 경험 앞당기기"] } },
    { id: "day5PresentationVerification", time: "10:07", speaker: "한도윤", dynamic: "presentationProposalDetail", text: "조사 결과를 반영한 개선안을 말씀드리겠습니다.", visual: "도윤이 DAY 1에서 선택한 개선 방향을 구체적인 실행안으로 연결한다.", bgAssetId: meeting },
    { id: "day5PresentationVerificationDetail", time: "10:08", speaker: "한도윤", dynamic: "presentationProposalConclusion", text: "개선안의 적용 방식과 운영 기준을 설명한다.", visual: "개선안의 적용 범위와 운영 기준이 이어서 표시된다.", bgAssetId: meeting },
    { id: "day5PresentationBoundary", time: "10:09", speaker: "한도윤", text: "개선안은 일부 신규 유저에게 먼저 적용하고 기존 흐름과 비교하겠습니다.", visual: "일부 적용 범위와 첫 전투 도달률 목표, 잔존율 확인 계획이 함께 표시된다.", bgAssetId: meeting, system: { title: "적용 및 검증 계획", rows: ["적용 · 일부 신규 유저", "현재 첫 전투 도달률 · 68.1%", "1차 목표 · 73.1% / +5%p", "함께 확인 · 7일 후 잔존율 18.4%"] } },
    { id: "day5PresentationBoundaryCriteria", time: "10:09", speaker: "한도윤", text: "도달률과 7일 후 잔존율이 함께 개선될 때만 전체 적용하겠습니다.", visual: "전체 적용을 위한 두 가지 성공 조건이 강조된다.", bgAssetId: meeting, system: { title: "적용 및 검증 계획", rows: ["적용 · 일부 신규 유저", "현재 첫 전투 도달률 · 68.1%", "1차 목표 · 73.1% / +5%p", "함께 확인 · 7일 후 잔존율 18.4%"] } },
    ...
    { id: "day5PresentationNormal", time: "10:11", speaker: "한도윤", text: "목표는 설명을 더 듣게 하는 것이 아니라 RPG의 핵심 재미를 먼저 경험하게 하는 것입니다.", visual: "발표 마지막 화면이 결론 요약으로 전환된다.", bgAssetId: meeting },
    { id: "day5PresentationNormalConclusion", time: "10:11", speaker: "한도윤", text: "작게 검증한 뒤 도달률과 잔존율이 함께 개선되면 전체 적용하겠습니다. 이상입니다.", visual: "발표 마지막 화면이 결론 요약으로 전환된다.", bgAssetId: meeting },
    ...
    { id: "day5NormalQaAnswer", time: "10:13", speaker: "한도윤", text: "첫 전투 도달률만으로 성공을 판단하지 않겠습니다.", visual: "도달률과 잔존율을 함께 확인하는 확대 적용 조건이 화면에 표시된다.", bgAssetId: meeting },
    { id: "day5NormalQaAnswerDetail", time: "10:13", speaker: "한도윤", text: "다음 날 복귀와 7일 후 잔존율, 신규 유저 의견까지 함께 확인하겠습니다.", visual: "도달률과 잔존율을 함께 확인하는 확대 적용 조건이 화면에 표시된다.", bgAssetId: meeting },
    { id: "day5NormalQaAccepted", time: "10:14", speaker: "평가위원", text: "도달률뿐 아니라 이후 잔존과 사용자 반응도 보겠다는 뜻이군요.", visual: "평가위원이 답변을 확인하고 공식 근거 자료를 요청한다.", bgAssetId: meeting },
    { id: "day5NormalQaAcceptedSource", time: "10:14", speaker: "평가위원", text: "현재 기준 수치가 담긴 공식 근거 자료를 확인하겠습니다.", visual: "평가위원이 답변을 확인하고 공식 근거 자료를 요청한다.", bgAssetId: meeting },
    ...
    { id: "day5ProposalRestatement", time: "10:51", speaker: "한도윤", dynamic: "proposalRestatement", text: "최근 신규 유저의 7일 후 잔존율은 18.4%로, 개선이 필요합니다.", visual: "도윤이 현재 잔존율과 개선 필요성을 다시 정리한다.", bgAssetId: meeting },
    { id: "day5ProposalRestatementDetail", time: "10:51", speaker: "한도윤", dynamic: "proposalRestatementDetail", text: "도달률과 잔존율, 사용자 반응이 함께 좋아질 때만 전체 적용하겠습니다.", visual: "도윤이 확대 적용 조건을 다시 정리한다.", bgAssetId: meeting },
