(function initDay5Story(global) {
  ...
  const scenes = Object.freeze([
    ...
    { id: "day5PresentationStart", time: "10:00", speaker: "한도윤", dynamic: "presentationOpening", text: "신규 유저 첫 전투 도달률 개선안입니다. 먼저 이탈 규모부터 보시죠.", location: "발표실 · 발표", visual: "도윤이 신규 유저 첫 전투 도달률 개선안 발표를 시작한다.", bgAssetId: meeting, system: { title: "신규 유저 첫 전투 도달률 개선안", rows: ["현재 문제 · 첫 전투 이전 이탈", "개선 원칙 · 첫 성공 경험 앞당기기", "적용 방식 · 일부 신규 유저 대상 검증"] }, bgm: "presentationCalm" },
    { id: "day5PresentationProblem", time: "10:01", speaker: "한도윤", text: "최근 신규 설치자는 1만 2,500여 명. 그중 8,500여 명이 첫 전투까지 왔습니다.", visual: "신규 설치부터 첫 전투 도달까지의 퍼널과 이탈 규모가 발표 화면에 표시된다.", bgAssetId: meeting, system: { title: "현재 문제", rows: ["신규 설치 · 12,480명", "첫 전투 도달 · 8,502명", "첫 전투 이전 이탈 · 3,978명", "첫 전투 이전 이탈률 · 31.9%"] } },
    { id: "day5PresentationProblemScale", time: "10:01", speaker: "한도윤", text: "약 4,000명, 전체의 31.9%가 핵심 재미를 보기 전에 떠나는 셈이죠.", visual: "첫 전투 이전 이탈 인원과 비율이 강조된다.", bgAssetId: meeting, system: { title: "현재 문제", rows: ["신규 설치 · 12,480명", "첫 전투 도달 · 8,502명", "첫 전투 이전 이탈 · 3,978명", "첫 전투 이전 이탈률 · 31.9%"] } },
    { id: "day5PresentationSolution", time: "10:03", speaker: "한도윤", text: "최근 신규 유저의 7일 후 잔존율은 18.4%. 개선 여지가 분명하죠.", visual: "현재 7일 차 잔존율과 개선 필요성이 발표 화면에 표시된다.", bgAssetId: meeting, system: { title: "현재 잔존율", rows: ["7일 후 잔존율 · 18.4%", "대상 · 신규 유저", "자료 기준 · 가장 최근 자료", "평가 · 개선 필요"] } },
    { id: "day5PresentationFocusDetail", time: "10:04", speaker: "한도윤", dynamic: "presentationResearchEvidence", text: "그렇다면 첫 전투 전에 왜 떠날까요? 사용자 조사 결과를 보겠습니다.", visual: "도윤이 DAY 2에서 조사한 원인 근거를 발표 화면에 연결한다.", bgAssetId: meeting },
    { id: "day5PresentationFocusConclusion", time: "10:05", speaker: "한도윤", dynamic: "presentationResearchConclusion", text: "조사에서 드러난 핵심은 안내량보다 안내 순서였습니다.", visual: "조사 결과의 핵심 원인이 발표 화면에 강조된다.", bgAssetId: meeting },
    { id: "day5PresentationMetric", time: "10:06", speaker: "한도윤", text: "조사 방식은 달라도 공통점은 하나였습니다. 통제권과 다음 목표의 상실.", visual: "서로 다른 조사 결과가 하나의 공통 결론으로 모인다.", bgAssetId: meeting, system: { title: "공통 결론", rows: ["공통 원인 · 통제권과 다음 목표 상실", "개선 방향 · 설명 추가가 아닌 순서 조정", "목표 · 첫 성공 경험 앞당기기"] }, camera: "focus" },
    { id: "day5PresentationMetricConclusion", time: "10:06", speaker: "한도윤", text: "그래서 설명 대신 첫 행동과 성공을 앞당기는 쪽을 택했습니다.", visual: "첫 성공 경험을 앞당기는 개선 방향이 강조된다.", bgAssetId: meeting, system: { title: "공통 결론", rows: ["공통 원인 · 통제권과 다음 목표 상실", "개선 방향 · 설명 추가가 아닌 순서 조정", "목표 · 첫 성공 경험 앞당기기"] } },
    { id: "day5PresentationVerification", time: "10:07", speaker: "한도윤", dynamic: "presentationProposalDetail", text: "이제 이 원인을 실제 개선안으로 연결해 보죠.", visual: "도윤이 DAY 1에서 선택한 개선 방향을 구체적인 실행안으로 연결한다.", bgAssetId: meeting },
    { id: "day5PresentationVerificationDetail", time: "10:08", speaker: "한도윤", dynamic: "presentationProposalConclusion", text: "적용 방식과 운영 기준은 다음과 같습니다.", visual: "개선안의 적용 범위와 운영 기준이 이어서 표시된다.", bgAssetId: meeting },
    { id: "day5PresentationBoundary", time: "10:09", speaker: "한도윤", text: "일부 신규 유저부터 적용합니다. 목표는 68.1%에서 73.1%.", visual: "일부 적용 범위와 첫 전투 도달률 목표, 잔존율 확인 계획이 함께 표시된다.", bgAssetId: meeting, system: { title: "적용 및 검증 계획", rows: ["적용 · 일부 신규 유저", "현재 첫 전투 도달률 · 68.1%", "1차 목표 · 73.1% / +5%p", "함께 확인 · 7일 후 잔존율 18.4%"] } },
    { id: "day5PresentationBoundaryCriteria", time: "10:09", speaker: "한도윤", text: "5%포인트 오른 뒤에도 잔존율과 사용자 반응이 좋아야 다음 단계로 갈 수 있죠.", visual: "전체 적용을 위한 세 가지 성공 조건이 강조된다.", bgAssetId: meeting, system: { title: "적용 및 검증 계획", rows: ["적용 · 일부 신규 유저", "현재 첫 전투 도달률 · 68.1%", "1차 목표 · 73.1% / +5%p", "함께 확인 · 7일 후 잔존율 18.4%"] } },
    ...
    { id: "day5PresentationNormal", time: "10:11", speaker: "한도윤", text: "목표는 더 많이 설명하는 데 있지 않습니다. RPG의 재미를 먼저 보여 주는 것.", visual: "발표 마지막 화면이 결론 요약으로 전환된다.", bgAssetId: meeting },
    { id: "day5PresentationNormalConclusion", time: "10:11", speaker: "한도윤", text: "도달률·잔존율·사용자 반응을 확인한 뒤 확대하겠습니다. 여기까지입니다.", visual: "발표 마지막 화면이 결론 요약으로 전환된다.", bgAssetId: meeting },
    { id: "day5NormalQaQuestion", time: "10:12", speaker: "평가위원", text: "안내를 줄이면 도달률은 높아져도 필요한 정보를 놓칠 수 있습니다.", visual: "평가위원이 지표 개선과 지연된 이탈을 구분할 방법을 묻는다.", bgAssetId: meeting },
    { id: "day5NormalQaQuestionDetail", time: "10:12", speaker: "평가위원", text: "단순히 이탈 시점만 늦춘 것은 아닌지 어떻게 구분하겠습니까?", visual: "평가위원이 지표 개선과 지연된 이탈을 구분할 방법을 묻는다.", bgAssetId: meeting },
    { id: "day5NormalQaAnswer", time: "10:13", speaker: "한도윤", text: "도달률 하나만 올랐다고 성공이라 볼 수는 없습니다.", visual: "도달률과 잔존율을 함께 확인하는 확대 적용 조건이 화면에 표시된다.", bgAssetId: meeting },
    { id: "day5NormalQaAnswerDetail", time: "10:13", speaker: "한도윤", text: "다음 날 복귀, 7일 후 잔존율, 신규 유저 불편 의견까지 함께 보죠.", visual: "도달률과 잔존율을 함께 확인하는 확대 적용 조건이 화면에 표시된다.", bgAssetId: meeting },
    { id: "day5NormalQaAccepted", time: "10:14", speaker: "평가위원", text: "좋습니다. 도달률뿐 아니라 이후 잔존과 사용자 반응도 보는군요.", visual: "평가위원이 답변을 확인하고 공식 근거 자료를 요청한다.", bgAssetId: meeting },
    { id: "day5NormalQaAcceptedSource", time: "10:14", speaker: "평가위원", text: "그럼 현재 기준 수치의 공식 근거 자료를 확인하죠.", visual: "평가위원이 답변을 확인하고 공식 근거 자료를 요청한다.", bgAssetId: meeting },
    ...
    { id: "day5Mismatch", time: "10:18", speaker: "평가위원", text: "발표 자료는 18.4%인데 제출 근거에는 12.7%가 표시됩니다.", emphasis: ["18.4%", "12.7%"], visual: "대형 화면에 서로 다른 두 수치가 나란히 표시된다.", bgAssetId: meeting, system: { title: "수치 불일치 발견", rows: ["발표 자료 수치 · 18.4%", "제출용 근거 자료 수치 · 12.7%", "확인 필요 · 다른 시점인지 연결 변경인지", "현재 상태 · 원인 확인 중"] }, bgm: "presentationUrgent", bgmHardCut: true },
    { id: "day5MismatchQuestion", time: "10:18", speaker: "평가위원", text: "자료 시점이 다른지, 제출 후 연결이 바뀐 것인지 기록으로 설명해 주세요.", visual: "대형 화면에 서로 다른 두 수치가 나란히 표시된다.", bgAssetId: meeting, system: { title: "수치 불일치 발견", rows: ["발표 자료 수치 · 18.4%", "제출용 근거 자료 수치 · 12.7%", "확인 필요 · 다른 시점인지 연결 변경인지", "현재 상태 · 원인 확인 중"] } },
    ...
    { id: "day5MismatchFollowup", time: "10:18", speaker: "평가위원", text: "산정 기준이 다른지, 제출 이후 자료가 바뀐 것인지 설명해 주세요.", visual: "두 수치 아래에 산정 기준과 제출 이후 변경 여부가 질문으로 표시된다.", bgAssetId: meeting },
    ...
    { id: "day5Pause", time: "10:24", speaker: "평가위원", text: "질의응답을 잠시 멈추겠습니다. 어느 수치가 현재 기준인지 확인해 주세요.", visual: "질의응답이 잠시 멈추고 PPT가 오류 확인 순서로 전환된다.", bgAssetId: meeting, bgm: "presentationUrgent" },
    { id: "day5PauseSequence", time: "10:24", speaker: "평가위원", text: "제출 당시 상태와 이후 변경 내역도 기록 순서대로 확인해 주세요.", visual: "질의응답이 잠시 멈추고 PPT가 오류 확인 순서로 전환된다.", bgAssetId: meeting },
    ...
    { id: "day5AuditResultReview", time: "10:29", speaker: "한도윤", text: "규칙 소유자는 서하린 선배지만 이번 재실행 요청 계정은 강민재입니다.", emphasis: ["서하린", "강민재"], visual: "도윤이 열린 감사 로그에서 규칙 소유자와 실제 요청 계정을 구분해 읽는다.", bgAssetId: meeting, auditCutin: true },
    { id: "day5AuditResultReviewDetail", time: "10:29", speaker: "한도윤", text: "연결 변경은 나나봇이 수행했고, 직접 수치 입력 기록은 없습니다.", emphasis: "나나봇", visual: "도윤이 실행 서비스와 직접 수치 입력 기록을 구분해 읽는다.", bgAssetId: meeting },
    ...
    { id: "day5MinjaeConfront", time: "10:41", speaker: "강민재", dynamic: "verificationConfront", text: "재실행 요청은 내가 했어. 공식 근거 자료까지 바뀔 줄은 몰랐어.", visual: "오류 검증 결과에 따라 민재가 즉시 인정하거나 먼저 책임 범위를 방어한다.", bgAssetId: meeting, characters: minjaeConcerned },
    ...
    { id: "day5SupportRecoveryShock", time: "10:45", speaker: "한도윤", dynamic: "supportRecoveryShock", text: "다섯 번의 기회를 모두 썼다. 상황이 얼마나 위태로운지 이제야 실감났다.", visual: "도윤이 더 이상 반응하지 않는 키보드와 마우스를 내려다본다.", bgAssetId: meeting, supportRecovery: true },
    ...
    { id: "day5SupportRecoveryProcess", time: "10:47", speaker: "시스템 담당자", text: "자동 갱신을 멈춘 뒤 제출 원본과 분석 기준을 확인하고 연결을 고정합니다.", visual: "담당자가 남은 네 단계 복구를 자동으로 수행하며 각 단계가 차례로 완료 표시된다.", bgAssetId: meeting, supportRecovery: true, system: { title: "지원 복구 진행", rows: ["01 · 자동 갱신 중지", "02 · 정상 원본 18.4% 선택", "03 · 분석 대상과 기간 확인", "04 · 원본 연결 고정"] } },
    ...
    { id: "day5Resume", time: "10:50", speaker: "한도윤", dynamic: "resumeStatement", text: "현재 수치와 과거 자료의 출처 차이를 보고드리겠습니다.", visual: "도윤이 복구 결과와 변경 경로를 평가위원에게 제시한다.", bgAssetId: meeting, bgm: "presentationCalm" },
    { id: "day5ResumeDetail", time: "10:50", speaker: "한도윤", dynamic: "resumeStatementDetail", text: "복구 결과와 제출 이후 변경 경로를 이어서 보고한다.", visual: "도윤이 복구 결과와 변경 경로를 평가위원에게 제시한다.", bgAssetId: meeting },
    { id: "day5ProposalRestatement", time: "10:51", speaker: "한도윤", dynamic: "proposalRestatement", text: "최근 신규 유저의 7일 후 잔존율은 18.4%. 개선 여지는 여전합니다.", visual: "도윤이 현재 잔존율과 개선 필요성을 다시 정리한다.", bgAssetId: meeting },
    { id: "day5ProposalRestatementDetail", time: "10:51", speaker: "한도윤", dynamic: "proposalRestatementDetail", text: "1차 목표는 73.1%. 잔존율과 사용자 반응까지 좋아져야 확대할 수 있습니다.", visual: "도윤이 확대 적용 조건을 다시 정리한다.", bgAssetId: meeting },
    { id: "day5ResumeContinue", time: "10:52", speaker: "평가위원", text: "현재 수치와 2024년 자료의 연결 오류, 제안의 검증 범위를 확인했습니다.", visual: "평가위원이 정정된 수치와 검증 범위를 확인하고 기록을 넘긴다.", bgAssetId: meeting },
    { id: "day5ResumeContinueDetail", time: "10:52", speaker: "평가위원", text: "개선안과 사고 대응 과정을 함께 최종 평가하겠습니다.", visual: "평가위원이 정정된 수치와 검증 범위를 확인하고 기록을 넘긴다.", bgAssetId: meeting },
    ...
    { id: "day5ResumeAnswer", time: "10:56", speaker: "한도윤", text: "개선안의 근거는 오늘 다시 검증한 원본과 일치합니다.", visual: "도윤이 사고 대응과 개선안의 실제 효과를 분명히 구분해 답한다.", bgAssetId: meeting },
    { id: "day5ResumeAnswerDetail", time: "10:56", speaker: "한도윤", text: "이번 사고는 자료 관리 문제이므로 개선 효과와 분리해 판단해 주십시오.", visual: "도윤이 사고 대응과 개선안의 실제 효과를 분명히 구분해 답한다.", bgAssetId: meeting },
    ...
    { id: "day5BadEnd", ending: "bad", time: "20:20", speaker: "한도윤", text: "그래, 여기까진가 보다.\n\nBAD ENDING\n정직원 전환은 끝내 승인되지 않았다. 도윤은 짐 상자를 들고 어두워진 사무실을 나섰다.", location: "게임사업실 · 퇴사", visual: "도윤이 개인 물품을 담은 상자를 품에 안고 사무실 문을 나선다. 창밖은 이미 캄캄하다.", bgAssetId: "background.office.night", cgAssetId: "event_cg.day5.lone_departure", cgTitle: "홀로 남은 퇴근길", cinematicDelay: 3000, end: true, bgm: "badEnding" },
    ...
    { id: "day5MiddleEnd", ending: "middle", time: "18:25", speaker: "한도윤", text: "저도 오늘 선배 없었으면 못 버텼을 겁니다.\n\nMIDDLE ENDING\n사수와 신입으로 시작한 두 사람은 서로 믿고 일할 수 있는 동료가 되었다.", visual: "로비 회전문 앞에서, 두 사람이 나란히 걸음을 멈춘다.", bgAssetId: officeLobby, characters: harinSmile, cgAssetId: "event_cg.day5.colleague_departure", cgTitle: "함께한 퇴근길", cinematicDelay: 3000, end: true, bgm: "middleEnding" },
    ...
    { id: "day5HappyEnd", ending: "happy", time: "18:22", speaker: "서하린", text: "시간 괜찮아요?\n\nHAPPY ENDING\n발표는 끝났지만, 두 사람의 다음 일정은 이제 시작된다.", visual: "1층 표시와 점등된 버튼 아래에서 하린이 주말 약속을 묻는다. 도윤이 대답하려는 순간 화면이 어두워진다.", bgAssetId: elevator, cgAssetId: "event_cg.day5.weekend_invitation", cgTitle: "서하린의 주말 약속", cinematicDelay: 3000, end: true, bgm: "happyEnding", camera: "romance" },
  ]);
  ...
  function validateScenes(items) {
    ...
    items.forEach((scene, index) => {
      if (scene.id === "day5PresentationStart") inPresentation = true;
      ...
      if (inPresentation) {
        const dialogue = [scene.text, ...(scene.choices || []).flatMap((choice) => [choice.text, choice.reply])];
        if (dialogue.some((line) => typeof line === "string" && line.length > 60)) {
          errors.push(`presentation dialogue exceeds 60 characters at ${scene.id || index}`);
        }
      }
      if (scene.id === "day5PresentationEnd") inPresentation = false;
    });
    return errors;
  }
