(function initDay5Story(global) {
  ...
  const scenes = Object.freeze([
    ...
    { id: "day5OriginalCheck", time: "09:06", speaker: "한도윤", text: "18.4%. 7월 27일~8월 2일 신규 가입자. 보존한 원본과 어제 제출 기록 모두 이상 없습니다.", visual: "도윤이 보존된 발표 자료와 제출 확인 기록을 대조한다.", bgAssetId: office, system: { title: "발표 전 최종 확인", rows: ["7일 차 잔존율 · 18.4%", "분석 대상 · 신규 가입 사용자", "분석 기준 · 7/27~8/2 가입자", "추가 수정 · 없음"] } },
    ...
    { id: "day5FinalCheckReply", time: "09:10", speaker: "한도윤", text: "18.4%, 신규 가입 사용자, 7월 27일~8월 2일 가입자. 원본과 계산식까지 준비했습니다.", visual: "도윤이 핵심 수치와 분석 기준, 원본 계산식의 위치를 차례로 확인한다.", bgAssetId: office, characters: harinConcerned },
    ...
    { id: "day5PresentationMetric", time: "10:07", speaker: "한도윤", text: "그 결과 7월 27일부터 8월 2일까지 가입한 신규 가입자의 7일 차 잔존율은 18.4%로 확인됐습니다. 단순 조회값이 아니라 같은 대상과 기간을 고정해 다시 계산한 결과입니다.", emphasis: ["7월 27일부터 8월 2일까지", "신규 가입자", "18.4%"], visual: "대형 스크린 중앙에 18.4%와 분석 대상, 기간이 차례로 강조된다.", bgAssetId: meeting, system: { title: "개선 결과", rows: ["7일 차 잔존율 · 18.4%", "분석 대상 · 신규 가입 사용자", "분석 기간 · 7/27~8/2", "계산식 · (7일 차 잔존 유저 수) ÷ (신규 가입자 수) × 100", "확인 결과 · 원본과 계산 결과 일치"] }, camera: "focus" },
    { id: "day5PresentationVerification", time: "10:09", speaker: "한도윤", text: "DAY 2에는 원본 데이터와 계산식을 서로 맞대어 확인했고, DAY 4 제출 직후에는 발표 자료와 근거 자료의 수치가 모두 18.4%인지 다시 확인했습니다.", emphasis: "18.4%", visual: "DAY 2 수치 확인 기록과 DAY 4 제출 직후 확인 화면이 연결되어 표시된다.", bgAssetId: meeting, system: { title: "수치 확인 과정", rows: ["DAY 2 · 원본과 계산식 대조", "DAY 4 · 제출 직후 다시 확인", "발표 자료 · 18.4%", "근거 자료 · 18.4%"] } },
    ...
    { id: "day5Mismatch", time: "10:18", speaker: "평가위원", text: "발표 자료와 제출용 검증 자료의 수치가 다릅니다! 발표 자료는 18.4%인데, 제출용 검증 자료에는 12.7%로 표시돼 있습니다.", emphasis: ["18.4%", "12.7%"], visual: "대형 화면에 서로 다른 두 수치가 나란히 표시된다.", bgAssetId: meeting, system: { title: "수치 불일치 발견", rows: ["발표 자료 수치 · 18.4%", "제출용 검증 자료 수치 · 12.7%", "분석 기준 · 같은지 확인 필요", "현재 상태 · 원인 확인 중"] }, bgm: "presentationUrgent", bgmHardCut: true },
    ...
    { id: "day5NormalProved", time: "10:21", speaker: "한도윤", text: "DAY 2 수치 확인 기록입니다. 7월 27일~8월 2일 신규 가입자의 7일 차 잔존율은 18.4%로 확인됐습니다.", emphasis: ["7일 차", "18.4%"], visual: "확인된 원본과 계산식이 평가 화면에 표시된다.", bgAssetId: meeting, system: { title: "확인된 원본 수치", rows: ["7일 차 잔존율 · 18.4%", "분석 대상 · 신규 가입 사용자", "분석 기준 · 7/27~8/2 가입자", "계산식 · (7일 차 잔존 유저 수) ÷ (신규 가입자 수) × 100", "DAY 2 · 원본과 계산 결과 일치"] } },
    ...
    { id: "day5MinjaeConfront", time: "10:41", speaker: "강민재", dynamic: "verificationConfront", text: "재실행 요청은 내가 했어. 예전 검증 자료를 빨리 다시 쓰려던 거였고, 공식 근거 자료까지 바뀔 줄은 몰랐어.", visual: "오류 검증 결과에 따라 민재가 즉시 인정하거나 먼저 책임 범위를 방어한다.", bgAssetId: meeting, characters: minjae },
    { id: "day5MinjaeWhy", time: "10:42", speaker: "한도윤", dynamic: "verificationFollowup", text: "DAY 3에 이상 징후를 봤으면서 왜 말 안 했어?", visual: "검증 실패 시 보안 감사 로그 원문 전체가 다시 열리고, 그 외에는 도윤이 미보고 이유를 묻는다.", bgAssetId: meeting, characters: minjae },
    ...
    { id: "day5RecoveryBasis", time: "10:47", speaker: "한도윤", text: "발표 자료와 같은 분석 대상과 기간을 확인하자.", visual: "PPT에 분석 대상과 기간 조합이 비교 표시된다.", bgAssetId: meeting, playerRecovery: true, system: { title: "03 · 분석 기준 확인", rows: ["발표 자료 대상 · 신규 가입 사용자", "발표 자료 기간 · 7/27~8/2", "측정 시점 · 가입 7일 후", "선택 · 같은 분석 기준"] }, choiceKey: "recoveryBasis", choices: [
      { id: "new_users_current_week", text: "신규 가입 사용자 · 7/27~8/2 · 가입 7일 후를 선택한다.", delta: { work: 1 }, replySpeaker: "한도윤", reply: "발표 자료와 같은 분석 대상과 기간을 확인했습니다." },
      { id: "all_users_current_week", text: "전체 사용자 · 7/27~8/2 · 가입 7일 후를 선택한다.", delta: { work: -1 }, replySpeaker: "평가위원", reply: "분석 대상이 발표 자료와 다릅니다." },
    ...
    { id: "day5Resume", time: "10:50", speaker: "한도윤", dynamic: "resumeStatement", text: "정상 원본과 동일한 18.4% 수치로 증빙 자료를 복구했습니다.", visual: "도윤이 복구 결과와 변경 경로를 평가위원에게 제시한다.", bgAssetId: meeting, bgm: "presentationCalm" },
    { id: "day5ResumeContinue", time: "10:52", speaker: "한도윤", text: "발표를 다시 이어가겠습니다. 확인된 근거를 기준으로, 신규 사용자의 7일 차 잔존율은 여전히 18.4%이며 개선 방향도 변하지 않았습니다.", emphasis: "18.4%", visual: "도윤이 흐트러진 호흡을 가다듬고 발표 화면을 다시 앞으로 넘긴다.", bgAssetId: meeting },
    ...
    { id: "day5EvaluatorClose", time: "10:58", speaker: "평가위원", dynamic: "evaluatorCloseResult", text: "발표 중 문제가 발생했지만 정상 원본과 제출 이후 변경 경로는 확인했습니다. 사고 대응을 포함해 최종 평가하겠습니다.", visual: "발표실 스크린에 최종 검토 상태가 표시된다.", bgAssetId: meeting },
    ...
    { id: "day5DoyunThanks", time: "11:14", speaker: "한도윤", text: "저도 혼자였다면 첫 질문에서부터 흔들렸을 겁니다. 아침에 해 주신 말과 따뜻한 차까지 전부 도움이 됐습니다.", visual: "도윤이 발표 전 하린이 건넨 조언과 차를 떠올리며 감사 인사를 전한다.", bgAssetId: hallway, characters: harinSmile },
    ...
    { id: "day5MinjaeAfterHours", time: "16:10", speaker: "강민재", text: "재실행 권한은 벌써 회수됐더라. 당연한 거긴 한데… 그래도 좀 그렇네.", visual: "민재가 자리를 정리하다 도윤 쪽을 잠깐 바라본다.", bgAssetId: office, characters: minjae },
    { id: "day5MinjaeAfterHoursReply", time: "16:11", speaker: "한도윤", text: "필요하면 나중에 다시 얘기하자. 지금은 결과부터 기다리자.", visual: "도윤이 짧게 답하고 다시 화면으로 시선을 돌린다.", bgAssetId: office, characters: minjae },
