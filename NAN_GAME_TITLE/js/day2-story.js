(function initDay2Story(global) {
  ...
  const scenes = [
    ...
    { id: "day2Lunch1", time: "12:20", speaker: "강민재", text: "밖에서 먹자고 한 건 좋은데, 왜 하필 제일 줄 긴 집이야?", char: "minjae", placeholder: { title: "회사 밖 식당 · 점심", detail: "점심시간, 직장인들이 줄을 선 작은 식당" }, location: "회사 밖 식당 · 점심" },
    ...
    { id: "day2LunchReply", time: "12:37", speaker: "한도윤", text: "확인은 해보겠습니다.", char: "minjae", placeholder: "inherit" },
    ...
    { id: "day2ArchiveRecognition", time: "14:33", speaker: "한도윤", text: "이 폴더, 어제 봤던….", char: "harin" },
    ...
    { id: "day2ArchiveHarin1", time: "14:34", speaker: "서하린", text: "그건 예전에 쓰던 연결이에요. 지금은 꺼져 있어요.", char: "harin" },
    { id: "day2ArchiveDoyun", time: "14:34", speaker: "한도윤", text: "선배 이름이 남아 있네요.", char: "harin" },
    { id: "day2ArchiveHarin2", time: "14:35", speaker: "서하린", text: "제가 만들었으니까요. 지금 필요한 틀은 그 아래 ‘공용 발표 기본형’이에요.", char: "harin" },
    { id: "day2BuildNotice", time: "14:35", speaker: "시스템", text: "윤세아에게 새 메시지가 도착했습니다.\n“오후 빌드 점검 10분 뒤 시작합니다.”", notification: "sea-build" },
    { id: "day2ArchiveExit", time: "14:36", speaker: "서하린", text: "빌드부터 보고 와요. 이건 나중에 확인해도 됩니다.", char: "harin", bgm: "daily" },

    { id: "day2BuildSea", time: "14:45", speaker: "윤세아", text: "새 빌드에서 튜토리얼 팝업이 두 번 뜬다는 제보가 있어요. 재현되는지만 확인 부탁드려요.", char: "sea", placeholder: { title: "오후 빌드 점검", detail: "테스트 단말에 같은 튜토리얼 팝업이 두 번 나타난 화면" }, location: "QA 테스트 공간 · 오후" },
    ...
    { id: "day2OvertimeLead", time: "19:25", speaker: "한도윤", text: "오후 빌드 점검 결과까지 전달하고 나니 사무실에 남은 사람은 거의 없었다.", bgm: "overtime", placeholder: { title: "게임사업실 · 야간", detail: "절반의 조명이 꺼지고 모니터와 스탠드만 켜진 사무실" }, location: "게임사업실 · 야간" },
    ...
    { id: "day2CoffeeHarin", time: "19:40", speaker: "서하린", text: "자판기 다녀왔어요. 이건 도윤 씨 것.", placeholderCharacter: { name: "서하린", detail: "살짝 지친 표정으로 캔 커피를 들고 있음" }, placeholder: "inherit" },
    { id: "day2CoffeeDoyun", time: "19:41", speaker: "한도윤", text: "선배 건 설탕 없는 라테죠?", placeholderCharacter: { name: "서하린", detail: "살짝 지친 표정으로 캔 커피를 들고 있음" }, placeholder: "inherit" },
    { id: "day2CoffeeBranch1", time: "19:42", speaker: "서하린", dynamic: "coffeeHarin", placeholderCharacter: { name: "서하린", detail: "캔 커피를 들고 작게 웃음" }, placeholder: "inherit" },
    { id: "day2CoffeeBranch2", time: "19:43", speaker: "한도윤", dynamic: "coffeeDoyun", placeholderCharacter: { name: "서하린", detail: "캔 커피를 들고 작게 웃음" }, placeholder: "inherit" },

    { id: "day2Past1", time: "19:48", speaker: "서하린", text: "예전에도 이렇게 늦게까지 자료를 정리한 적이 있어요.", char: "harin", placeholder: "inherit" },
    { id: "day2Past2", time: "19:49", speaker: "한도윤", text: "아까 잠깐 보였던 폴더와 관련 있습니까?", char: "harin", placeholder: "inherit" },
    { id: "day2Past3", time: "19:50", speaker: "서하린", text: "네. 그때는 제가 전부 해결해야 한다고 생각했어요. 결과는 좋지 않았고요.", char: "harin", placeholder: "inherit" },
    { id: "day2Past4", time: "19:51", speaker: "한도윤", text: "그래서 혼자 하려는 사람을 보면 그냥 지나치지 못하는 겁니까?", char: "harin", placeholder: "inherit" },
    { id: "day2Past5", time: "19:52", speaker: "서하린", text: "…비슷해 보이면요.", char: "harin", placeholder: "inherit" },
    { id: "day2Past6", time: "19:53", speaker: "한도윤", text: "더 묻지는 않겠습니다.", char: "harin", placeholder: "inherit" },
    { id: "day2Past7", time: "19:54", speaker: "서하린", text: "고마워요. 아직은 그게 더 편해요.", char: "harin", placeholder: "inherit" },
    {
