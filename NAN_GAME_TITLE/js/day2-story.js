(function initDay2Story(global) {
  ...
  const scenes = [
    ...
    { id: "day2Lunch1", time: "12:20", speaker: "강민재", text: "그래도 음식 나오니까 기다린 보람은 있네. 오전 내내 울리던 메신저 소리도 이제 좀 잊힌다.", bg: "restaurant_lunch", char: "minjae", location: "회사 밖 식당 · 점심" },
    ...
    { id: "day2Lunch4", time: "12:23", speaker: "한도윤", text: "오전에는 서로 메신저도 못 볼 만큼 바쁘더니 점심 메뉴는 동시에 정하네.", char: "minjae", placeholder: "inherit" },
