...
function renderSaveSlots() {
  ...
  saveSlots.replaceChildren(...slots.map((slot) => {
    ...
    button.addEventListener("click", () => {
      ...
      closeSavePanel();
      window.location.href = slot.resumeUrl || (Number(slot.day) === 5 ? "day5.html" : Number(slot.day) === 4 ? "day4.html" : Number(slot.day) === 3 ? "day3.html" : Number(slot.day) === 2 ? "day2.html" : "game.html");
    });
    return button;
  }));
}
