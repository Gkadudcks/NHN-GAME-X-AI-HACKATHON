(function initDay3Story(global) {
  ...
  const scenes = [
    ...
    { id: "day3HarinPlan", time: "10:46", speaker: "서하린", dynamic: "harinPlan", char: "harin" },
    { id: "day3Decision", time: "10:47", speaker: "서하린", text: "기록에 제 이름이 있는 건 부정하지 않을게요. 도윤 씨는 지금 어떻게 생각해요?", characters: [{ id: "harin", assetId: "character.harin.arms_folded.concerned" }], activeCharacter: "harin", choiceKey: "harinSuspicion", choices: [
    ...
    { id: "day3DecisionResult", time: "10:48", speaker: "서하린", dynamic: "decisionResponse", characters: [{ id: "harin", assetId: "character.harin.arms_folded.concerned" }], activeCharacter: "harin" },
