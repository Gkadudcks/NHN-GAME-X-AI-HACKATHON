(function initDay3Story(global) {
  ...
  const scenes = [
    ...
    { id: "day3HarinSeesChange", time: "09:12", speaker: "서하린", text: "잠깐만요. 이건 제가 검토한 문장이 아닌데요? 복원부터 하면 안 돼요. 지금 상태와 변경 기록부터 남겨요.", characters: [{ id: "harin", assetId: "character.harin.hand_to_chest.surprised" }], activeCharacter: "harin", motion: "surprised", camera: "impact", effect: "document-impact" },
    { id: "day3HistoryOpen", time: "09:18", speaker: "시스템", text: "변경 시각은 09:03, 표시된 편집자는 서하린으로 기록되어 있다.", emphasis: "09:03", systemPanel: { title: "REVISION HISTORY", rows: ["09:03 · 자동 문장 정리", "표시된 편집자 · 서하린", "실행 계정 / 기기 · 권한 필요"] }, clue: CLUES.harinEditor },
    ...
    { id: "day3HarinResponse", time: "09:20", speaker: "서하린", text: "…잠깐만요. 왜 제 이름이 여기 남아 있죠? 오늘 아침에는 이 문서를 열지도 않았어요.", characters: [{ id: "harin", assetId: "character.harin.hand_to_chest.surprised" }], activeCharacter: "harin", motion: "nervous", camera: "tension" },
    ...
    { id: "day3NanabotRun", time: "10:06", speaker: "나나봇", text: "연결된 자동화 요청에 따라 09:03에 문장을 정리했습니다. 요청 주체는 현재 권한으로 표시할 수 없습니다.", emphasis: "09:03", char: "nanabot", clue: CLUES.automationRun },
    { id: "day3Decision", time: "10:12", speaker: "한도윤", text: "수정 기록에는 선배의 이름이 있고, 바뀐 문장은 나나봇의 방식과 닮았다. 아직 선배의 설명은 듣지 못했다. 나는 지금 무엇을 기준으로 판단해야 할까?", bg: "office", camera: "tension", effect: "decision-focus", choiceKey: "harinSuspicion", choices: [
    ...
    { id: "day3FolderPathFirst", time: "13:38", speaker: "시스템", text: "첫 조사 대상으로 이전 자료가 연결된 과정을 선택했습니다.", systemPanel: { title: "자료 연결 과정", rows: ["이전 자료 · 2024_신규유저개선_이전자료", "자동 기능 · 발표 자료 자동 연결", "현재 파일 · 신규유저_초반이탈개선_발표자료_작업본"] }, clue: CLUES.accessUnconfirmed, when: { decision: "investigationFirst", equals: "folder" } },
    ...
    { id: "day3ElevatorCg", time: "18:15", speaker: "서하린", dynamic: "departureHarin", bg: "elevator_lobby_night", cgAssetId: "event_cg.day3.elevator_waiting", cgTitle: "기다렸어요, 오늘은", camera: "romance", cinematicDelay: 1300, location: "엘리베이터 로비 · 퇴근", when: { decision: "elevatorPlan", equals: "wait" } },
    { id: "day3ElevatorAfterCg", time: "18:16", speaker: "한도윤", text: "선배와 눈이 마주쳤다. 열린 엘리베이터 안쪽의 따뜻한 불빛보다, 나를 기다렸다는 그 미소가 먼저 눈에 들어왔다.", bg: "elevator_lobby_night", char: "harin", location: "엘리베이터 로비 · 퇴근", when: { decision: "elevatorPlan", equals: "wait" } },
    { id: "day3ElevatorLobby", time: "18:15", speaker: "서하린", text: "저도 이제 가려던 참이에요. 로비까지만 같이 내려가요.", char: "harin", bg: "elevator_lobby_night", location: "엘리베이터 로비 · 퇴근", when: { decision: "elevatorPlan", equals: "lobby" } },
    { id: "day3DepartureHarin", time: "18:15", speaker: "서하린", text: "오늘은 먼저 들어가요. 내일 기록 확인부터 마무리해요.", char: "harin", bg: "office_night", when: { decision: "elevatorPlan", equals: "leave" } },
