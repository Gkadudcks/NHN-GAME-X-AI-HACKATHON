(function initDay3Story(global) {
  ...
  const MESSAGES = Object.freeze([
    ...
    { id: "d3-harin-check", room: "harin", at: "day3MinigameResult", sender: "서하린 사수", dynamic: "secretChatMessage", day: 3, time: "10:44" },
    { id: "d3-harin-delayed-check", room: "harin", at: "day3HarinDelayedReply", sender: "서하린 사수", text: "이제 기록을 확인했어요. 오늘 아침에는 그 문서를 직접 열지 않았어요. 제 이름이 남은 경로부터 보죠.", day: 3, time: "12:31" },
  ...
  const scenes = [
    ...
    { id: "day3BossPressure", time: "10:15", speaker: "박태식", text: "원인 확인은 어디까지 됐어? 확인 안 된 이름은 채널에 올리지 말고, 점심 전에는 조사 방향만 보고해.", char: "boss", bg: "office" },
    { id: "day3PrivateContactLead", time: "10:17", speaker: "한도윤", text: "선배는 다른 회의로 자리를 비웠다. 공개 채널에서 이름부터 꺼내면, 확인되지 않은 의심이 기록으로 남는다.", bg: "office" },
    { id: "day3ContactObjective", time: "10:18", speaker: "한도윤", text: "먼저 세 가지만 확인하자. 오늘 아침 문서를 열었는지, 자동화에 소유자 이름만 남을 수 있는지, DAY 2 복원 지점을 그대로 보존할지.", bg: "office" },
    { id: "day3SecretChatStart", time: "10:20", speaker: "시스템", text: "박태식 부장의 시선을 피해 서하린에게 확인 메시지를 전송합니다.", bg: "office", bgm: "minigame", startSecretChat: true },
    { id: "day3MinigameResult", time: "10:44", speaker: "서하린", dynamic: "secretChatResult", char: "harin", bgm: "daily", notification: "d3-harin-check" },
    { id: "day3HarinPlan", time: "10:46", speaker: "서하린", dynamic: "decisionResponse", char: "harin" },
