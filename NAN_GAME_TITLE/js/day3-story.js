(function initDay3Story(global) {
  ...
  const scenes = [
    ...
    { id: "day3HistoryOpen", time: "09:18", speaker: "시스템", text: "변경 시각은 09:03, 표시된 편집자는 서하린으로 기록되어 있다.", emphasis: ["09:03", "서하린"], systemPanel: { title: "REVISION HISTORY", rows: ["09:03 · 자동 문장 정리", "표시된 편집자 · 서하린", "실행 계정 / 기기 · 권한 필요"] }, clue: CLUES.harinEditor },
    ...
    { id: "day3NanabotRun", time: "10:06", speaker: "나나봇", text: "연결된 자동화 요청에 따라 09:03에 문장을 정리했습니다. 요청 주체는 현재 권한으로 표시할 수 없습니다.", emphasis: ["09:03", "요청 주체"], char: "nanabot", clue: CLUES.automationRun },
