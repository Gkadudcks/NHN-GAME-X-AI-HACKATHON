(function exposeSecretChat(root, factory) {
  ...
  function messageReply(index = 0, affection = 0) {
    ...
    const replies = [
      ...
      {
        low: "저도 그렇더라고요.",
        mid: "그러니까요. 이 근처 사는 줄은 몰랐어요.",
        high: "저만 그런 거 아니었네요. 앞으로 자주 마주치겠어요.",
      },
      {
        low: "일단 오늘 일부터 마무리해요.",
  ...
  function reply(gradeResult = "good", affection = 0) {
    ...
    const dialogue = {
      perfect: {
        ...
        mid: "저도 아직 신기해요, 이웃이라는 거. 점심 메뉴는 조사 끝나고 같이 정해요.",
        high: "그러게요, 이 동네에 도윤 씨가 있을 줄은. 다음에 마주치면 커피는 제가 살게요.",
      },
      good: {
        low: "메시지 봤어요. 점심 이야기는 조사 끝나고 다시 해요.",
        mid: "저도 아직 어색해요, 이웃이라는 거. 시간 되면 점심 메뉴 같이 봐요.",
        high: "메시지 보자마자 웃었어요. 그 얘기는 나중에 하고, 일 끝나면 같이 고르러 가요.",
      },
      caught: {
        low: "부장님 바로 앞이라 길게 답은 못 하겠어요. 업무에 집중해요.",
        mid: "부장님 바로 앞이라 길게 답은 못 하겠어요. 이웃 얘기는 나중에 해요.",
        high: "지금 부장님 보고 있죠? 답장은 나중에 해도 돼요. 커피 얘기는 일 끝나고 해요.",
      },
    }[gradeResult] || {};
    const message = {
      low: "메시지는 확인했어요. 점심 이야기는 조사 끝나고 다시 해요.",
      mid: "저도 아직 신기합니다, 이웃이라는 거. 점심 메뉴는 조금 있다가 같이 봐요.",
